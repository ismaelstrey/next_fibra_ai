 ...
 * Componente raiz para diálogos/modais
 */
const Dialog = DialogPrimitive.Root;

/**
 * Componente DialogTrigger
 * Elemento que aciona a abertura do diálogo
 */
const DialogTrigger = DialogPrimitive.Trigger;

/**
 * Componente DialogPortal
 * Portal para renderizar o diálogo fora da hierarquia do DOM
 */
const DialogPortal = ({
  ...props
 ...
 * Sobreposição que cobre a tela quando o diálogo está aberto
 */
