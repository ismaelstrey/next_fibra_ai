/*
  ...
  - You are about to drop the `_CapilarToTubo` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropIndex
DROP INDEX "_CapilarToTubo_B_index";

-- DropIndex
DROP INDEX "_CapilarToTubo_AB_unique";

-- DropTable
PRAGMA foreign_keys=off;
DROP TABLE "_CapilarToTubo";
...
CREATE TABLE "new_Capilar" (
    ...
    CONSTRAINT "Capilar_tuboId_fkey" FOREIGN KEY ("tuboId") REFERENCES "Tubo" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
