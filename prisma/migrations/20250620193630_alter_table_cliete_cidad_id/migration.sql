...
INSERT INTO "new_Cliente" ("apartamento", "casa", "email", "endereco", "id", "neutraId", "nome", "numero", "portaId", "potencia", "senha", "senhaWifi", "telefone", "wifi") SELECT "apartamento", "casa", "email", "endereco", "id", "neutraId", "nome", "numero", "portaId", "potencia", "senha", "senhaWifi", "telefone", "wifi" FROM "Cliente";
DROP TABLE "Cliente";
