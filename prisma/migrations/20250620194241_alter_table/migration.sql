...
INSERT INTO "new_Equipamento" ("atualizadoEm", "caixaId", "cidadeId", "clienteId", "criadoEm", "dataInstalacao", "descricao", "emendaId", "fabricante", "id", "modelo", "nome", "numeroSerie", "observacoes", "status", "tipo", "usuarioId") SELECT "atualizadoEm", "caixaId", "cidadeId", "clienteId", "criadoEm", "dataInstalacao", "descricao", "emendaId", "fabricante", "id", "modelo", "nome", "numeroSerie", "observacoes", "status", "tipo", "usuarioId" FROM "Equipamento";
