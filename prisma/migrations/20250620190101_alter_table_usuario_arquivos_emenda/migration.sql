...
INSERT INTO "new_Arquivo" ("caixaId", "capilarId", "criadoEm", "eventoId", "id", "manutencaoId", "nome", "relatorioId", "rotaId", "tipo", "url", "usuarioId") SELECT "caixaId", "capilarId", "criadoEm", "eventoId", "id", "manutencaoId", "nome", "relatorioId", "rotaId", "tipo", "url", "usuarioId" FROM "Arquivo";
DROP TABLE "Arquivo";
