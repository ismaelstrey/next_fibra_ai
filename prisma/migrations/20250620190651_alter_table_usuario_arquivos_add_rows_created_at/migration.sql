/*
  ...
  - Added the required column `updatedAt` to the `Arquivo` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Arquivo" ("caixaId", "capilarId", "clienteId", "criadoEm", "emendaId", "eventoId", "id", "manutencaoId", "nome", "relatorioId", "rotaId", "tamanho", "tipo", "url", "usuarioId") SELECT "caixaId", "capilarId", "clienteId", "criadoEm", "emendaId", "eventoId", "id", "manutencaoId", "nome", "relatorioId", "rotaId", "tamanho", "tipo", "url", "usuarioId" FROM "Arquivo";
DROP TABLE "Arquivo";
