...
INSERT INTO "new_Arquivo" ("caixaId", "criadoEm", "eventoId", "id", "manutencaoId", "nome", "relatorioId", "rotaId", "tipo", "url", "usuarioId") SELECT "caixaId", "criadoEm", "eventoId", "id", "manutencaoId", "nome", "relatorioId", "rotaId", "tipo", "url", "usuarioId" FROM "Arquivo";
DROP TABLE "Arquivo";
